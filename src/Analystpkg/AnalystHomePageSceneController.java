...
public class AnalystHomePageSceneController implements Initializable {
    ...
    @FXML
    private void AnalysePackagesOnClick(ActionEvent event) throws IOException {
    ...
    @FXML
    private void AnalysePackageDemandOnClick(ActionEvent event) throws IOException {
        Parent parent = FXMLLoader.load(getClass().getResource("PackageDemand.fxml"));
        BorderPane.setCenter(parent);
    }
